  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // Guardar isVerified como string 'true' o 'false' para evitar problemas de tipo
        localStorage.setItem("isVerified", String(response.isVerified));
        localStorage.setItem("emailToken", response.emailToken);
        localStorage.setItem("user-name", response.nameUser);
        setIsLogged(true);
