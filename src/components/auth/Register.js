...
function CreateRegister() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      setSuccessMessage(
        "Usuario creado con éxito. Revise su bandeja de entrada para confirmar su cuenta"
      );
      setErrorMessage("");
      setName("");
      setNumber("");
            ...
            {!redirectToHome ? (
              <>
                ...
                >
                  ...
                  <Modal.Footer>
                    <Button variant="success" onClick={handleSuccessAccept}>
                      Aceptar
                    </Button>
                  </Modal.Footer>
                </Modal>
                ...
                <Form onSubmit={handleSubmit} encType="multipart/form-data">
                  ...
                  <p>
                    No te pierdas de todas las cosas nuevas que tenemos para ti
                  </p>
                  <br />
